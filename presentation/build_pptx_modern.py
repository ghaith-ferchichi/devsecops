...
"Ce projet s'intitule BTE Security AI Agent : un agent d'intelligence artificielle pour la revue "
"automatisée de sécurité du code.",
# 2 — Sommaire
...
# 3 — Introduction
"(≈ 30 s) Pour situer l'enjeu : une seule injection SQL fusionnée dans une API de paiement peut "
"compromettre l'intégrité du système d'information de la banque. Or, à la BTE, la revue de sécurité "
"du code demeure entièrement manuelle : elle peut atteindre vingt-quatre heures, et sa qualité dépend "
"de la disponibilité et de l'expertise du relecteur. C'est ce constat qui motive ce travail.",
# 4 — Divider 1
"(≈ 5 s) Commençons par le contexte général.",
# 5 — Organisme & AS-IS
"(≈ 40 s) La BTE est une banque universelle née d'un partenariat entre l'État tunisien et l'Abu Dhabi "
"Investment Authority. Mon stage s'est déroulé au sein du pôle Sécurité de la Direction des Systèmes "
"d'Information. Le processus actuel, que vous voyez à gauche, repose intégralement sur l'examen "
"humain : le relecteur examine le diff dans GitHub, dépose ses commentaires, puis fusionne "
"manuellement. Aucune analyse statique, aucun gate de pipeline n'est greffé sur ce cycle.",
# 6 — Problématique
"(≈ 30 s) Quatre limites en découlent. Un délai pouvant atteindre vingt-quatre heures, selon la "
"disponibilité et l'expertise du relecteur. L'absence de tout blocage technique : une Pull Request "
"vulnérable peut être fusionnée. Une qualité de revue variable. Et des angles morts : les secrets "
"commités et les dépendances vulnérables échappent à l'œil humain.",
# 7 — Objectifs et contribution (builds : 3 clics)
"(≈ 40 s) Notre contribution tient en une phrase : un agent IA autonome qui revoit chaque Pull "
"Request selon l'OWASP Top 10 en une quinzaine de minutes, publie les correctifs sur GitHub, et "
"s'exécute intégralement en local — aucun code ne quitte la banque. [clic] De vingt-quatre heures à "
"quinze minutes. [clic] Cinq vulnérabilités sur cinq détectées lors de la validation. [clic] Et zéro "
"ligne de code ne sort du VPS.",
# 8 — Solution TO-BE
"(≈ 30 s) Concrètement, voici le processus cible : GitHub émet un webhook signé ; l'agent classifie "
"la Pull Request, exécute cinq scanners en parallèle, consolide leurs résultats avec un modèle de "
"langage local, puis publie la revue, le score et le verdict. Et c'est ce verdict qui conditionne la fusion.",
# 9 — Méthodologie
"(≈ 30 s) Le projet a été conduit selon la méthode Scrumban : la cadence de sprints de Scrum, la "
"discipline de flux de Kanban avec un travail en cours limité à un. Dix sprints sur cinq mois. Chaque "
"incident de production est devenu la carte prioritaire du sprint en cours — c'est ainsi qu'ont été "
"absorbés l'urgence disque et la réécriture du parser de revue.",
# 10 — Divider 2
"(≈ 5 s) Passons à l'état de l'art et aux choix technologiques.",
# 11 — DevSecOps
"(≈ 25 s) Le cadre conceptuel est le DevSecOps et son principe de shift-left : intégrer la sécurité au "
"plus tôt du cycle, idéalement dès la Pull Request. Notre apport consiste à transformer le verdict de "
"l'agent en un gate technique, qui conditionne réellement la fusion.",
# 12 — Besoins
"(≈ 35 s) Côté besoins fonctionnels : détecter les vulnérabilités, produire la revue OWASP, publier "
"les commentaires, conditionner la fusion, et offrir un assistant d'exploitation. Côté non "
"fonctionnel, la contrainte dominante est la confidentialité : l'inférence doit rester locale, "
"conformément aux exigences de la Banque Centrale de Tunisie. S'y ajoutent la performance, la "
"résilience et l'observabilité.",
# 13 — Benchmark
"(≈ 40 s) Le choix des modèles repose sur un banc d'essai mené sur notre propre matériel. Deux modèles "
"ressortent : qwen2.5-coder 7B et 14B, à égalité de précision d'appel d'outils — quatre-vingts pour "
"cent — le 7B étant nettement plus rapide. D'où une architecture à deux modèles : le 7B classifie en "
"trente secondes, le 14B mène l'analyse approfondie. Un benchmark croisé a par ailleurs confirmé le "
"choix d'Ollama : vingt-deux pour cent de débit de plus que LocalAI, sur un fichier de poids identique.",
# 14 — Technologies retenues
"(≈ 30 s) L'ensemble s'appuie sur trois briques : cinq scanners spécialisés, chacun couvrant une "
"classe de risque ; deux modèles de langage locaux ; et l'orchestrateur LangGraph, retenu pour sa "
"persistance d'état native. Les sorties des scanners sont nettoyées — moins cinquante-deux pour cent "
"de tokens — avant transmission au modèle.",
# 15 — Positionnement
"(≈ 30 s) Aucune solution existante ne combine raisonnement par modèle de langage et inférence "
"entièrement locale : CodeQL, Snyk et Copilot transmettent le code au cloud ; SonarQube reste "
"auto-hébergeable mais sans explication en langage naturel. C'est notre différenciateur : rien ne "
"sort du VPS de la banque.",
# 16 — Divider 3
"(≈ 5 s) Venons-en à la conception.",
# 17 — Architecture
"(≈ 30 s) La plateforme compte onze conteneurs organisés en quatre couches : la couche d'entrée, avec "
"nginx qui valide les webhooks ; la couche IA — FastAPI, LangGraph et Ollama ; la couche données — "
"PostgreSQL et Redis ; et la couche observabilité, sur laquelle je reviendrai.",
# 18 — Manifeste (builds : 6 clics)
"(≈ 40 s) J'insiste sur ce point : il s'agit d'un agent, et non d'un simple appel à un modèle. Six "
"capacités le démontrent. [clics] Il perçoit les événements GitHub ; il raisonne et route son graphe "
"d'état ; il agit — commente, bloque, escalade ; il persiste son état et reprend après un "
"redémarrage ; il manipule dix-neuf outils réels ; et il s'auto-exploite au quotidien.",
# 19 — Pipeline (builds : 7 clics)
"(≈ 45 s) Le cœur du système est un graphe d'état à neuf nœuds. Suivons une Pull Request. [clics] "
"Réception et déduplication du webhook ; classification par le modèle 7B ; routage des scanners selon "
"la nature des fichiers ; exécution parallèle des cinq scanners ; analyse combinée par le 14B selon "
"l'OWASP Top 10 ; verdict ; publication sur GitHub. La fusion des deux appels du 14B en un seul a "
"réduit la durée totale du pipeline de moitié.",
# 20 — Fiabilité
"(≈ 35 s) La question légitime : peut-on faire confiance à un modèle de langage ? Six couches de "
"protection éliminent les hallucinations — température zéro, fenêtre de contexte maîtrisée, garde "
"d'outils, et surtout un parser qui élimine tout commentaire portant sur une ligne inexistante du "
"diff. C'est ce qui permet de publier sur GitHub sans aucune erreur de ligne.",
# 21 — Divider 4
"(≈ 5 s) Passons à la réalisation et aux résultats.",
# 22 — Environnement
"(≈ 25 s) Le terrain d'exécution est volontairement contraint : un VPS de production de douze cœurs "
"Haswell, quarante-cinq giga-octets de mémoire, et sans GPU. La pile logicielle est intégralement "
"open source : Docker, Python, FastAPI, LangGraph, PostgreSQL, Redis et les cinq scanners.",
# 23 — Défense en profondeur
"(≈ 35 s) La détection suit une logique de défense en profondeur : chaque scanner couvre une classe "
"de risque — CVE, secrets, code applicatif, infrastructure, dépendances — et le modèle consolide "
"l'ensemble. Les deux se complètent : sur la PR de démonstration, le modèle a détecté des secrets en "
"dur que Gitleaks n'avait pas signalés.",
# 24 — Démonstration (GIF + build BLOCK)
"(≈ 45 s) Voici la démonstration, sur la Pull Request numéro dix-huit : un module bancaire contenant "
"cinq vulnérabilités types. À l'écran, la revue publiée par l'agent défile jusqu'au verdict. [clic] "
"BLOCK. Cinq commentaires inline, chacun avec une suggestion applicable en un clic, et le statut de "
"commit passe en échec : la fusion est techniquement bloquée.",
# 25 — Bénéfices & résultats
"(≈ 35 s) Le tableau résume le passage du processus manuel à l'agent : un délai divisé par près de "
"cent ; une couverture OWASP systématique ; un gate effectif ; et la confidentialité garantie. Sur le "
"jeu contrôlé, l'agent obtient cinq sur cinq, complétés par huit revues réelles persistées en base.",
# 26 — Observabilité
"(≈ 30 s) L'agent voit l'intégralité du VPS : vingt-huit métriques, quinze règles d'alerte, trois "
"tableaux de bord. Cette supervision n'est pas décorative : elle a permis de détecter un AlertManager "
"silencieusement hors service et une panne de VictoriaMetrics de neuf jours.",
# 27 — Chat & autonomie
"(≈ 30 s) Au-delà de la revue, un assistant conversationnel doté de dix-neuf outils permet "
"d'interroger l'infrastructure en langage naturel : l'agent invoque l'outil réel et répond avec la "
"valeur mesurée — jamais inventée. Et il s'auto-exploite : scheduler autonome, health digest "
"quotidien sur Slack, gardien disque auto-réparateur.",
# 28 — Phi-4
"(≈ 30 s) L'épisode le plus révélateur : la télémétrie a mis en évidence un bug du modèle Phi-4, qui "
"renvoyait zéro token sans aucune erreur journalisée. Le système a donc détecté une panne invisible "
"aux journaux — diagnostiquée, corrigée, puis vérifiée. C'est, je crois, la meilleure preuve qu'il "
"s'agit d'un système qui se surveille lui-même.",
# 29 — Tests et validation
"(≈ 30 s) La validation finale a couvert les mécanismes critiques : rejet des signatures invalides, "
"déduplication des webhooks, circuit breaker avec repli en cas d'indisponibilité du modèle, et "
"déclenchement du gardien disque. Une checklist de quatorze vérifications de bout en bout a été "
"intégralement validée avant la livraison.",
# 30 — Divider 5
"(≈ 5 s) J'en viens à la conclusion.",
# 31 — Limites & perspectives
"(≈ 40 s) Trois limites assumées : l'inférence sur CPU, qui borne la revue à quinze-vingt-cinq "
"minutes ; un durcissement réseau à compléter ; et un corpus d'évaluation restreint. Trois "
"perspectives : la migration GPU — environ trois mille euros — ramènerait chaque revue à deux à cinq "
"minutes ; le passage à l'échelle de l'ensemble des dépôts de la banque ; et un tableau de bord de "
"risque destiné au RSSI.",
# 32 — Conclusion
"(≈ 30 s) En conclusion : un agent IA agentique, déployé en production à la BTE, qui sécurise chaque "
"Pull Request sans qu'aucun code ne quitte la banque. La plateforme est remise à la banque et "
"constitue un socle concret pour sa transformation DevSecOps. Je vous remercie de votre attention et "
"me tiens à votre disposition pour répondre à vos questions.",
]
