...
\vspace{6mm}
\includegraphics[width=1.1\columnwidth]{LogoISI.png}\\
\end{minipage}
\hfill
...
\vspace{6mm}
\includegraphics[width=0.9\columnwidth]{Logo_UTM.png}\\
\end{minipage}
\vskip1.5cm
...
\begin{figure}[h]
\centering
{\color{isiBlue}{\fboxrule=2.5pt\fbox{\includegraphics[width=0.4\columnwidth]{logo_BTE.png}}}}
\end{figure}
\end{center}
