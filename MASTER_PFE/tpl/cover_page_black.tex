...
\vspace{6mm}
\includegraphics[width=1.1\columnwidth]{Logo_ISI_Black.png}\\
\end{minipage}
\hfill
...
\vspace{6mm}
\includegraphics[width=0.9\columnwidth]{Logo_UTM_Black.png}\\
\end{minipage}
\vskip1.5cm
...
\begin{center}
\large
Réalisé au sein de la \@companyName\\
\vskip0.4cm
\begin{figure}[h]
\centering
{{\fboxrule=2.5pt\fbox{\includegraphics[width=0.4\columnwidth]{logo_BTE_Black.png}}}}
\end{figure}
\end{center}
