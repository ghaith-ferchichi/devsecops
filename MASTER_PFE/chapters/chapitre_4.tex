...
\section{Implémentation par sprints Scrumban}
    ...
    \subsection{Sprint 1 — Fondations : VPS, Docker et webhook GitHub}
        ...
        Docker et à valider la réception des webhooks GitHub.
        ...
        et le démarrage des onze conteneurs. Ces étapes relèvent de la pratique
        courante d'administration système Linux et ne sont pas détaillées ici. La suite de
        ...
        La configuration de performance d'Ollama est critique pour un fonctionnement CPU-only.
        ...
        L'intégration du webhook GitHub a buté sur un problème de transport :
        nginx, configuré en HTTP/1.0 par défaut, altérait les corps chunked des requêtes
        GitHub et provoquait systématiquement des erreurs 500. La figure \ref{fig:nginx_fix}
    ...
    \subsection{Sprint 2 — Pipeline de sécurité : scanners et LLM}
        ...
        workflow LangGraph \cite{LangGraph}. Ce sprint a par ailleurs introduit un diff
        généré localement, avec quinze lignes de contexte au lieu des trois lignes que
        l'API GitHub renvoie par défaut. La figure \ref{fig:diff_comparison} illustre la
        différence de qualité entre les deux approches sur un exemple de vulnérabilité
        SQL injection.
    ...
    \subsection{Sprint 3 — Revue combinée et commentaires inline GitHub}
        ...
        \begin{figure}[H]
            \centering
            \frame{\includegraphics[width=0.92\columnwidth]{pr_comment-security-review_0}}
        ...
        \begin{figure}[H]
            \centering
            \frame{\includegraphics[width=0.92\columnwidth]{pr_comment-security-review_1}}
        ...
        \begin{figure}[H]
            \centering
            \frame{\includegraphics[width=0.92\columnwidth]{pr_comment-security-review_2}}
...
if backend == "ollama":
    ...
    llm = ChatOpenAI(base_url=f"{settings.localai_base_url}/v1",
        ...
        Le premier essai grandeur réelle a échoué. Après
...
async def _prime_localai_model(model: str) -> None:
    ...
    \subsection{Sprint 8.1 — Expansion de l'observabilité et correction du \textit{template} Phi-4}
        ...
        a soulevé une nouvelle question : comment mesurer la qualité
        ...
        été clair : cAdvisor est architecturalement incompatible avec la
