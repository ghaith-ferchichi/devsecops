...
\section{Présentation de l'architecture logicielle}
    ...
    \subsection{Routage et point d'entrée}
        ...
        \hline
        \texttt{POST /\allowbreak{}webhooks/\allowbreak{}github} & agent:8000 & 30s & HMAC \\
        \hline
        \texttt{/grafana/} & grafana:3000 & défaut & Grafana auth \\
        \hline
        \texttt{/\allowbreak{}prometheus/} & prometheus:9090 & défaut & — \\
        \hline
        \end{tabular}
...
\section{Description de la conception du logiciel}
    ...
    \subsection{Sous-système d'inférence LLM}
        ...
        la configuration \texttt{OLLAMA\_\allowbreak{}MAX\_\allowbreak{}LOADED\_\allowbreak{}MODELS=1} garantit qu'un seul modèle
        ...
        \texttt{qwen2.\allowbreak{}5-coder:14B} est d'environ 3 tokens par seconde. Une
    ...
    \subsection{Sous-système d'analyse du diff}
        ...
        inexistante provoque une erreur 422 de l'API GitHub. Le module \texttt{diff\_\allowbreak{}parser.\allowbreak{}py}
        ...
        un espace, elle ajoute le numéro à l'ensemble des \texttt{context\_\allowbreak{}lines} et
        ...
        La fonction \texttt{diff\_\allowbreak{}lines\_\allowbreak{}for\_\allowbreak{}file} retourne l'union des ensembles
        \texttt{added\_lines} et \texttt{context\_\allowbreak{}lines}, représentant toutes les lignes
    ...
    \subsection{Sous-système d'assistant de chat opérationnel}
        ...
        objet JSON direct, d'un bloc \texttt{```json.\allowbreak{}.\allowbreak{}.\allowbreak{}```}, d'un JSON embarqué après du
        ...
        L'outil est exécuté via \texttt{asyncio.\allowbreak{}run\_\allowbreak{}in\_\allowbreak{}executor} avec résultat mis en cache
        ...
        La première couche est la configuration \texttt{temperature=0.\allowbreak{}0}, qui rend la
    ...
    \subsection{Sous-système d'observabilité}
        ...
        (\texttt{container\_\allowbreak{}running}, \texttt{container\_\allowbreak{}memory\_\allowbreak{}bytes},
        \texttt{container\_\allowbreak{}cpu\_\allowbreak{}percent}, \texttt{container\_\allowbreak{}network\_\allowbreak{}rx/\allowbreak{}tx\_\allowbreak{}bytes}, plus
        \texttt{container\_\allowbreak{}memory\_\allowbreak{}limit\_\allowbreak{}bytes}) émises par un \textit{poller} interrogeant le
        socket Docker toutes les trente secondes ; cinq métriques de santé pour la sandbox
        LocalAI (\texttt{localai\_\allowbreak{}reachable}, \texttt{localai\_\allowbreak{}models\_\allowbreak{}total},
        \texttt{localai\_\allowbreak{}model\_\allowbreak{}installed}, \texttt{localai\_\allowbreak{}model\_\allowbreak{}size\_\allowbreak{}gb},
        \texttt{localai\_\allowbreak{}health\_\allowbreak{}check\_\allowbreak{}latency\_\allowbreak{}seconds}) ; et quatre métriques de télémétrie
        A/B sur le routeur de chat (\texttt{chat\_\allowbreak{}requests\_\allowbreak{}total},
        \texttt{chat\_\allowbreak{}request\_\allowbreak{}seconds}, \texttt{chat\_\allowbreak{}first\_\allowbreak{}token\_\allowbreak{}seconds},
        \texttt{chat\_\allowbreak{}tokens\_\allowbreak{}streamed\_\allowbreak{}total}, toutes labellisées par \texttt{backend} et
        \texttt{model}) permettant la comparaison directe Ollama vs LocalAI sur les mêmes
        requêtes.

        Parmi les métriques héritées des sprints précédents, \texttt{ollama\_\allowbreak{}reachable} mérite
        ...
        entre deux revues PR) où \texttt{ollama\_\allowbreak{}reachable=1}, et Ollama injoignable (panne
        réelle) où \texttt{ollama\_\allowbreak{}reachable=0}. L'ancienne expression d'alerte utilisant
        \texttt{ollama\_\allowbreak{}models\_\allowbreak{}loaded\_\allowbreak{}total == 0} déclenchait systématiquement une fausse
        alerte CRITICAL pendant les périodes de veille. La métrique \texttt{ollama\_\allowbreak{}reachable}
        ...
        base d'images Docker historique située dans \texttt{/\allowbreak{}var/\allowbreak{}lib/\allowbreak{}docker/\allowbreak{}image/\allowbreak{}overlayfs/\allowbreak{}
        layerdb/\allowbreak{}mounts/} pour résoudre les identifiants de couches par conteneur. Or le démon
        Docker 29.4 de notre VPS utilise le \textit{containerd snapshotter}, qui ne maintient
        pas cette base : l'arborescence est désormais \texttt{/\allowbreak{}var/\allowbreak{}lib/\allowbreak{}docker/\allowbreak{}buildkit/\allowbreak{}
