...
\section{DevOps, CI/CD et DevSecOps}
    ...
    \subsection{Le DevOps}
        ...
        \begin{figure}[H]
            \centering
            \frame{\includegraphics[width=0.82\columnwidth]{devops_cycle}}
    ...
    \subsection{L'approche CI/CD}
        ...
        \begin{figure}[H]
            \centering
            \frame{\includegraphics[width=0.88\columnwidth]{cicd_pipeline}}
        ...
        \begin{figure}[H]
            \centering
            \frame{\includegraphics[width=0.88\columnwidth]{continuous_integration}}
    ...
    \subsection{L'OWASP Top 10}
        ...
        \begin{figure}[H]
            \centering
            \frame{\includegraphics[width=0.8\columnwidth]{owasp_top10}}
...
\section{Les grands modèles de langage (LLM)}
    ...
    \subsection{Fonctionnement général}
        ...
        \begin{figure}[H]
            \centering
            \frame{\includegraphics[width=0.82\columnwidth]{llm_context_window}}
...
\section{Analyse et définition des besoins}
    ...
    \subsection{Besoins fonctionnels}
        ...
        l'infrastructure via une interface de chat SSE avec dix-neuf outils de monitoring.
