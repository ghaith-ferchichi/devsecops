...
\section{DevOps, CI/CD et DevSecOps}
    ...
    \subsection{Du DevOps au DevSecOps}
        ...
        \textit{Pull Request}, avant toute fusion. Le \textit{feedback continu} complète
...
\section{Analyse et définition des besoins}
    ...
    \subsection{Besoins fonctionnels}
        ...
        \textbf{publié sur GitHub} — commentaire global dans l'onglet
        \textit{Conversation}, commentaires \textit{inline} dans l'onglet
        \textit{Files Changed}, et statut de commit positionné pour servir de \textit{gate}
        au CI/CD. Une fois la PR clôturée, la revue, les sorties brutes des scanners et la
    ...
    \subsection{Besoins non fonctionnels}
        ...
        ne quitte l'infrastructure BTE — c'est la condition de conformité réglementaire
        imposée par le secteur bancaire. Vient ensuite la \textbf{performance} : le
        pipeline complet, de la réception du webhook à la publication de la revue, doit
        tenir en moins de dix minutes pour ne pas peser sur les cycles de livraison. La
