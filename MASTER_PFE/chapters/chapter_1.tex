...
\section{Approche méthodologique}
    ...
    \subsection{Structure du tableau et choix des colonnes}
        ...
        \textbf{In Progress} est la colonne centrale. Sa limite WIP de 1 est la
    ...
    \subsection{Illustration d'un sprint sur l'agent}
        ...
        Scrumban tout au long du projet. Il a permis la création des cartes,
        le suivi des transitions de colonne, l'application des limites WIP
        et l'association aux jalons. Plutôt que d'énumérer ici la totalité
        du backlog, nous détaillons un sprint représentatif du cœur du
        travail : le sprint 3, consacré à l'assemblage du moteur de revue
        de sécurité.
        ...
        l'encadrant. Cette démonstration constitue le jalon M2.

        Sur ces deux semaines, la règle WIP=1 a été particulièrement
        utile. Les cartes étaient fortement dépendantes les unes des
        autres. Le parser ne pouvait être écrit avant que le format de
        sortie soit stabilisé, et la publication GitHub supposait un
        parser fonctionnel. La tentation d'attaquer plusieurs fronts en
