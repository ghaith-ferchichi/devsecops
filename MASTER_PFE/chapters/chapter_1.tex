...
\section{Approche méthodologique}
    ...
    \subsection{Illustration d'un sprint sur l'agent}
        ...
        du travail : le sprint 4, consacré à l'assemblage du moteur de
        revue de sécurité.
        ...
        \begin{figure}[H]
            \centering
            \frame{\includegraphics[width=\textwidth]{img/jira_sprint_s4}}
            \caption{Tableau Jira en fin de sprint 4 — cinq cartes
    ...
    \subsection{Déroulement du projet}
        ...
        2026, structurés en dix sprints de deux semaines : huit sprints de
        développement actif (2 février au 24 mai) suivis de deux sprints de
        polissage (25 mai au 21 juin) consacrés à l'évaluation d'un backend
        ...
        phase — passage du développement au polissage entre S8 et S9 —
